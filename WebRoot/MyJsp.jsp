...
<body id="body">
    ...
    <div class="row-fluid">
        <div class="span12">
            <h1 class="text-center">
                <strong>海洋水文数据世系管理系统</strong>
            </h1>
        </div>
    </div>
    <div class="row-fluid" style="height:800px;">
		<div class="span5" id="map_canvas" style="height:600px;border:#ccc solid 1px;float:left;">
        </div>
        <div class="span7">
        <div class="row-fluid">
			...
			<tr>
				<td>时间：</td>
				<td><input type="text" id="time" value = "2014/12/23 18:19"/>
				</td>
			</tr>
			<tr>
				<td>位置：</td>
				<td><span id="myLocation"></span>
				</td>
			</tr>
			...
			<tr>
				<td>盐度：</td>
				<td><span id="pscal"></span>
				</td>
			</tr>
			<tr>
				<td colspan="2"><span id="recordId"></span><br />
				</td>
			<tr>
				<td>温度<input type="radio" name="shixi" checked="checked" value="temp" />
				</td>
				<td>盐度<input type="radio" name="shixi" value="pscal" />
				</td>
			</tr>
			<tr>
				<td align="center" colspan="2">
					<button id="pedigreeQury" onclick=shixiQury() name="click">世系查询</button>
				</td>
			</tr>
			</table>
		</div>
		...
		<div class = "row-fluid">
            	<div id="tooltip" class = "tooltip" style="opacity:0; position: absolute;">
            		 <div class = "row" >
					...
					<!--<div class = "row" >
						<h7>&nbsp&nbsp&nbsp&nbspWhat:</h7>
						<h7 id = "what"></h7>
					</div>
					<div class = "row" >
						<h7>&nbsp&nbsp&nbsp&nbspWhen:</h7>
						<h7 id = "when"></h7>
					</div>
					<div class = "row" >
						<h7>&nbsp&nbsp&nbsp&nbspWho:</h7>
						<h7 id = "who"></h7>
					</div>
					<div class = "row" >
						<h7>&nbsp&nbsp&nbsp&nbspWhy:</h7>
						<h7 id = "why"></h7>
					</div>  -->
					<div class = "row" >
	...
	<script type="text/javascript">
		...
		function addMarker() {
			var marker = new BMap.Marker(new BMap.Point(119.567756,38.048786));
				...
				$("#myLocation")
						.html(
								"我的位置：" + "(" + ee.point.lng + ","
										+ ee.point.lat + ")");
				$("#myContent").html(
						"<p style='color:#dd0000'>" + ee.point.lng + "/"
								+ ee.point.lat + "</p>");
				var time = $("#time").val();
				if (checkDate()) {
			...
			marker = new BMap.Marker(new BMap.Point(122.216966,32.500918));
			marker.addEventListener("click", function(ee) {
				$("#myLocation")
						.html(
								"我的位置：" + "(" + ee.point.lng + ","
			...
			map.addOverlay(marker);
			marker = new BMap.Marker(new BMap.Point(112.79755,20.481977));
			marker.addEventListener("click", function(ee) {
				$("#myLocation")
						.html(
								"我的位置：" + "(" + ee.point.lng + ","
